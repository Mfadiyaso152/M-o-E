      ...
      >
        {!imageError ? (
          <img 
            ...
            className={`w-full h-full object-contain ${sizeMap[size].imgRounded} select-none drop-shadow-sm`}
