        ...
        {isFullyCertified ? (
          ...
          <form onSubmit={handleSignContract} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#1C3022] text-[#F8F5F0] py-4 rounded-2xl font-black text-xs hover:bg-[#122116] flex items-center justify-center gap-2 shadow-xl transition-all active:scale-[0.98] disabled:opacity-50"
            >
              {isSubmitting ? (
                <>
