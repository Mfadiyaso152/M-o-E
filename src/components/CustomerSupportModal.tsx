          ...
          <div className="flex-1 flex flex-col bg-[#FAF7F2] overflow-hidden">
            ...
            <form onSubmit={handleSendMessage} className="p-4 bg-white border-t border-[#E8E2D8] flex items-center gap-3">
              <input
                ...
                className="flex-1 bg-[#FAF7F2] border border-[#E8E2D8] rounded-full px-5 py-3.5 text-[13px] font-bold text-[#1C3022] outline-none focus:border-[#D0A97E]/50 transition-all placeholder-[#F8F5F0]/30"
              />
              <button
                type="submit"
