                    ...
                    <div className="p-3.5 bg-amber-50 border-2 border-amber-200 rounded-2xl space-y-2.5">
                      ...
                      <div className="flex flex-wrap gap-2 pt-1">
                        <button
                          type="button"
                          onClick={() => setQuoteForContractSigning(quote)}
                          className="bg-emerald-800 hover:bg-emerald-900 text-[#1C3022] px-3 py-1.5 rounded-xl text-xs font-black flex items-center gap-1 shadow-sm"
                        >
                    ...
                    <div className="p-3.5 bg-red-50 border-2 border-red-200 rounded-2xl space-y-2">
                      ...
                      <div className="flex gap-2 pt-1">
                        <button
                          ...
                          className="flex-1 bg-red-700 text-[#1C3022] py-2 rounded-xl text-xs font-black hover:bg-red-800 transition-all shadow-sm"
                        >
                          قبول إلغاء المشروع
                        </button>
                        <button
                  ...
                  <div className="flex flex-wrap items-center gap-1.5">
                    {item.installment.status !== 'paid' ? (
                      <button
                        ...
                        className="text-xs font-black text-[#1C3022] bg-emerald-700 hover:bg-emerald-800 px-3 py-1.5 rounded-xl flex items-center gap-1 shadow-sm transition-all active:scale-95"
                      >
                    ...
                    {item.installment.status === 'pending' && (
                      <button
                        ...
                        className={`text-xs font-black px-3 py-1.5 rounded-xl flex items-center gap-1 transition-all ${
                          overdueInfo.isOverdue7Days
                            ? 'bg-red-600 text-[#1C3022] hover:bg-red-700 shadow-sm'
