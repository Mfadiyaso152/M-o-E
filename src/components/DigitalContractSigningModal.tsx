  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-sm touch-none" dir="rtl">
      <motion.div
        ...
        className="bg-white rounded-3xl max-w-lg w-full max-h-[90vh] flex flex-col text-[#1C3022] border border-[#C5B198] shadow-2xl overflow-hidden touch-auto"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="bg-[#1C3022] text-white p-4 flex items-center justify-between shrink-0">
